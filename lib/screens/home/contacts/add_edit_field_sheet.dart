  ...
  Future<void> _saveField() async {
    ...
    try {
      if (widget.field != null) {
        ...
        await ContactsRepository.instance.updateContactField(updatedField);
      } else {
        // Create new field
        final newField = ContactField(
          contactId: widget.contactId,
          fieldType: fieldType,
          fieldValue: fieldValue,
        );
        await ContactsRepository.instance.insertContactField(newField);
      }
