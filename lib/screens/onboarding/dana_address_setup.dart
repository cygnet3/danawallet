...
class _DanaAddressSetupScreenState extends State<DanaAddressSetupScreen> {
  ...
  static const List<String> _reservedNames = [
    ...
    'bitcoin', 'satoshi', 'dana', 'official',
    'security', 'abuse', 'noreply', 'no-reply', 'donate',
  ];
  ...
  void _onFocusChange() {
    if (_focusNode.hasFocus) {
      ...
      if (!_hasUserEdited && widget.suggestedUsername != null && 
          _customUsernameController.text == widget.suggestedUsername) {
        _customUsernameController.clear();
      }
    } else {
      // When field loses focus, restore suggested username if empty
      if (_customUsernameController.text.isEmpty && widget.suggestedUsername != null) {
        _customUsernameController.text = widget.suggestedUsername!;
  ...
  String? _validateUsername(String username) {
    ...
    if (cleaned.contains('--') || cleaned.contains('..') || cleaned.contains('__')) {
  ...
  Widget build(BuildContext context) {
    ...
    final finalUsername = _customUsername?.isNotEmpty == true 
        ? _customUsername 
        : suggestedUsername;
    final finalDanaAddress = finalUsername != null ? '$finalUsername@$domain' : null;
        ...
        children: [
          ...
          AutoSizeText(
            ...
            style: BitcoinTextStyle.title3(Bitcoin.black)
                .copyWith(fontFamily: 'Inter', fontWeight: FontWeight.w700, fontSize: 26),
            maxLines: 1,
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  helperText: 'Letters, numbers, hyphens, periods, and underscores',
                    ...
                    SizedBox(
                      ...
                      child: _isCheckingAvailability
                          ...
                          : _isCustomUsernameAvailable == true
                              ? Icon(Icons.check_circle, color: Bitcoin.green, size: 24)
                              : _isCustomUsernameAvailable == false
                                  ? Icon(Icons.cancel, color: Bitcoin.red, size: 24)
                                  : Icon(Icons.help_outline, color: Bitcoin.neutral6, size: 24),
                    ),
          ...
          GestureDetector(
            onTap: () async {
              final url = Uri.parse('https://bitcoin.design/guide/how-it-works/human-readable-addresses/');
                ...
                children: [
                  ...
                  Flexible(
                    child: RichText(
                      textAlign: TextAlign.center,
                      text: TextSpan(
                        style: BitcoinTextStyle.body2(Bitcoin.neutral7).copyWith(fontSize: 11),
                        children: [
    ...
    final currentText = _customUsernameController.text.trim();
    final isUsingSuggested = !_hasUserEdited || currentText.isEmpty || currentText == widget.suggestedUsername;
