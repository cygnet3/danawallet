...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 148902095;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<String> crateApiSimpleBroadcastTx({required String tx, dynamic hint});
  ...
  Stream<BigInt> crateApiSimpleCreateAmountStream({dynamic hint});
  ...
  Stream<ScanProgress> crateApiSimpleCreateScanProgressStream({dynamic hint});

  Stream<SyncStatus> crateApiSimpleCreateSyncStream({dynamic hint});

  Future<String> crateApiSimpleExtractTxFromPsbt(
      {required String psbt, dynamic hint});
  ...
  Future<void> crateApiSimpleSyncBlockchain({dynamic hint});
