...
class WalletState extends ChangeNotifier {
  ...
  String generateThreeWordAlias(List<int> entropy, {int offset = 0}) {
    ...
    // Use different parts of the entropy to select 3 words
    ...
    final word3Index = (entropy[offset + 4] << 8 | entropy[offset + 5]) % wordlistSize;

    return '${wordlist[word1Index]}-${wordlist[word2Index]}-${wordlist[word3Index]}';
  }
