...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 477859478;
...
abstract class RustLibApi extends BaseApi {
  ...
  String crateApiStructsApiAmountDisplaybip177({required ApiAmount that});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  String crateApiStructsApiAmountDisplaybip177({required ApiAmount that}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiStructsApiAmountDisplaybip177ConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStructsApiAmountDisplaybip177ConstMeta =>
      const TaskConstMeta(
        debugName: "api_amount_displaybip177",
        argNames: ["that"],
      );
