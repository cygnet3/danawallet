...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -224311165;
...
abstract class RustLibApi extends BaseApi {
  ...
  SpWallet crateApiBackupWalletBackupAutoAccessorGetWallet(
      {required WalletBackup that});
  ...
  void crateApiBackupWalletBackupAutoAccessorSetWallet(
      {required WalletBackup that, required SpWallet wallet});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  SpWallet crateApiBackupWalletBackupAutoAccessorGetWallet(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiBackupWalletBackupAutoAccessorGetWalletConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiBackupWalletBackupAutoAccessorGetWalletConstMeta =>
      const TaskConstMeta(
        debugName: "WalletBackup_auto_accessor_get_wallet",
        argNames: ["that"],
      );
  ...
  void crateApiBackupWalletBackupAutoAccessorSetWallet(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiBackupWalletBackupAutoAccessorSetWalletConstMeta,
      argValues: [that, wallet],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiBackupWalletBackupAutoAccessorSetWalletConstMeta =>
      const TaskConstMeta(
        debugName: "WalletBackup_auto_accessor_set_wallet",
        argNames: ["that", "wallet"],
      );
  ...
  WalletBackup crateApiBackupWalletBackupNew(
    ...
    return handler.executeSync(SyncTask(
      ...
      argValues: [wallet, txHistory, ownedOutputs, seedPhrase, lastScan],
      apiImpl: this,
    ));
  }
...
class WalletBackupImpl extends RustOpaque implements WalletBackup {
  ...
  SpWallet get wallet =>
      RustLib.instance.api.crateApiBackupWalletBackupAutoAccessorGetWallet(
        that: this,
      );
  ...
  set wallet(SpWallet wallet) =>
      RustLib.instance.api.crateApiBackupWalletBackupAutoAccessorSetWallet(
          that: this, wallet: wallet);
}
