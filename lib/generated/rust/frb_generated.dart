...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -838693364;
...
abstract class RustLibApi extends BaseApi {
  ...
  String crateApiHistoryAddOutgoingTxToHistory(
  ...
  List<ApiRecordedTransaction> crateApiHistoryReadTxHistory(
      {required String encodedHistory});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  String crateApiHistoryAddOutgoingTxToHistory(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiHistoryAddOutgoingTxToHistoryConstMeta,
      argValues: [encodedHistory, txid, spentOutpoints, recipients, change],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiHistoryAddOutgoingTxToHistoryConstMeta =>
      const TaskConstMeta(
  ...
  List<ApiRecordedTransaction> crateApiHistoryReadTxHistory(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiHistoryReadTxHistoryConstMeta,
      argValues: [encodedHistory],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiHistoryReadTxHistoryConstMeta =>
      const TaskConstMeta(
        debugName: "read_tx_history",
  ...
  Future<void> crateApiWalletScanToTip(
    ...
    return handler.executeNormal(NormalTask(
      ...
      argValues: [blindbitUrl, dustLimit, encodedWallet, encodedHistory],
      apiImpl: this,
    ));
  }
  ...
  ScanResult sse_decode_scan_result(SseDeserializer deserializer) {
    ...
    return ScanResult(
        updatedWallet: var_updatedWallet,
